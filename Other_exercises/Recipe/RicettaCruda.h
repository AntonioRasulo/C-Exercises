...
#ifndef RICETTA_CRUDA_H
#define RICETTA_CRUDA_H

#include "Recipe.h"

class RicettaCruda: public Recipe
{
        public:
                RicettaCruda(const string& title_, const string& description_,const string& ingredient_,const float& quantity_);
                RicettaCruda();
                RicettaCruda(const string& title_, const string& description_);
